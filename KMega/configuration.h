...
//KKIM Interface
static const String COMMUNICATION_PORT = "COM3";
...
static const int INPUT_REFRESH_PACKET_SEND_RATE_IN_MILLISECONDS = 100; //100 seems pretty snappy, 500 is noticeably too slow
...
static const int GEARED_STEPPER_SPEED = 4000; // (steps per second)
