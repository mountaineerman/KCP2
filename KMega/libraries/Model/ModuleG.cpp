...
ModuleG::ModuleG(Adafruit_TLC5947& ledDriverBoards)
	...
	, stepper_Mach		(GEARED_STEPPER_SPEED, STEPPER_CCW_LIMIT, GEARED_STEPPER_CW_LIMIT)
	, stepper_Pitch		(GEARED_STEPPER_SPEED, STEPPER_CCW_LIMIT, GEARED_STEPPER_CW_LIMIT)
	, stepper_Heading 	()
{
