...
void PacketUnpacker::unpackGaugePacketIntoModel() {
	...
	//FIXME Add logic to switch between GaugePacket6 and GaugePacket5 based on Packet Header.
	...
	// controlPanel.moduleI.stepper_MonopropellantIntake.setDesiredPosition( this->convertTwoBytesInGaugePacketIntoInteger(10,11) );
	// controlPanel.moduleGT.stepper_Density.setDesiredPosition( this->convertTwoBytesInGaugePacketIntoInteger(12,13) );
	// controlPanel.moduleGT.stepper_Speed.setDesiredPosition( this->convertTwoBytesInGaugePacketIntoInteger(14,15) );
	// controlPanel.moduleGT.stepper_VertSpeed.setDesiredPosition( this->convertTwoBytesInGaugePacketIntoInteger(16,17) );
	// controlPanel.moduleGT.stepper_RadarAlt.setDesiredPosition( this->convertTwoBytesInGaugePacketIntoInteger(18,19) );
