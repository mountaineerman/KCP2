...
ModuleG::ModuleG()
	: stepper_Mach	(PIN_VID6606_1_FREQUENCY_MACH, 	PIN_VID6606_1_DIRECTION_MACH,  true,  MAX_GEARED_STEPPER_SPEED, STEPPER_CCW_LIMIT, STEPPER_CW_LIMIT)
	, stepper_Pitch	(PIN_VID6606_1_FREQUENCY_PITCH, PIN_VID6606_1_DIRECTION_PITCH, false, MAX_GEARED_STEPPER_SPEED, STEPPER_CCW_LIMIT, STEPPER_CW_LIMIT)
