...
ModuleC::ModuleC()
	: stepper_HeatLife		(PIN_VID6606_1_FREQUENCY_HEATLIFE,	PIN_VID6606_1_DIRECTION_HEATLIFE,	false,	MAX_GEARED_STEPPER_SPEED, STEPPER_CCW_LIMIT, STEPPER_CW_LIMIT)
	, stepper_Gforce		(PIN_VID6606_1_FREQUENCY_GFORCE,	PIN_VID6606_1_DIRECTION_GFORCE, 	false,	MAX_GEARED_STEPPER_SPEED, STEPPER_CCW_LIMIT, STEPPER_CW_LIMIT)
{
